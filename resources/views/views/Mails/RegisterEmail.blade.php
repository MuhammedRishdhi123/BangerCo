      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;">Hi {{$name}}Thank You for registering with us!</h1>
          </td>
        </tr>
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
            @if($status=='success')
            <p style="margin: 0;">Your account is successfully activated. Now you can login and access our website.</p>
            <b>Happy Journey !</b>
            @else
            <p style="margin: 0;">Your account is not accepted by our staff. Please contact our team for further details.</p>
            <b>Thank You!</b>
            @endif
          </td>
        </tr>
