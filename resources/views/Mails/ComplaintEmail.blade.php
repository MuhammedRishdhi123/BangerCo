      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;">Hi Sir </h1>
          </td>
        </tr>
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
          
            <p style="margin: 0;">We are from Banger Co. our registeration no.12131313</p><br>
            <b>We received a license which was stolen or lost who attempted to register with us.</b><br>
            <h4>Details</h4><br>
            <span>Date :{{$date}}</span><br>
            <span>License No. {{$licenseNo}}</span><br>
            <span>Registered email : {{$email}}</span><br>
           
            <p style="margin: 0;">Please kindly note that this is an automated email.</p>
            <b>Thank You!</b>
    ...
    <td bgcolor="#ee4c50" style="padding: 30px 30px;">
        ...
        <tr>
          <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;">
            <p style="margin: 0;">&reg; Banger Co. 2021<br/>
           <a href="#" style="color: #ffffff;">Unsubscribe</a> to this email instantly</p>
          </td>
          <td align="right">
